...
def res_check(coffe_type):
    ...
    if MENU[coffe_type]["ingredients"]["water"] > resources["water"]:
    ...
    elif MENU[coffe_type]["ingredients"]["milk"] > resources["milk"]:
        print("Not enough milk.")
        machine = "no resources"
    elif MENU[coffe_type]["ingredients"]["coffee"] > resources["coffee"]:
        ...
        for key in resources:
            if key == "money":
                break
            resources[key] -= MENU[coffe_type]["ingredients"][key]
